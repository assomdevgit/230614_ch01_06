...
# int(input()) 으로 입력을 받고, 해당 내용을 range(N)
...
import random # 파이썬 내장 라이브러리

print(random.random()) # 0 ~ 1 사이의 임의의 실수 (0은 포함, 1은 포함되지 않음)
